...
<title>UserPage - Emp</title>
</head>
<body>
<br>
<a href="user_editPassword">Change Password</a>&nbsp;&nbsp;&nbsp;
<a href="./user_editEmp?empId=${emp.id}">Edit Profile</a>
...
<br>
 <table border="1" width="30%">
		...
		<tr>
			<td><label id="loginLbl">Created Date</label> </td> <td> ${emp.date}</td>
		</tr>
